...
EMBY_API_KEY = os.environ.get('EMBY_KEY')
EMBY_ADMIN_USERNAME = os.environ.get('EMBY_ADMIN_USER')
EMBY_ADMIN_PASSWORD = os.environ.get('EMBY_ADMIN_PASS')
EMBY_SERVER_NICKNAME = os.environ.get('EMBY_SERVER_NAME')
EMBY_USER_POLICY = {
